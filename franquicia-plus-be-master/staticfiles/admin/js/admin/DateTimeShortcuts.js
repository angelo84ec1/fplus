...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        addClock: function(inp) {
            ...
            now_link.addEventListener('click', function(e : any) {
                e.preventDefault();
            ...
            clock_link.addEventListener('click', function(e : any) {
                e.preventDefault();
            ...
            clock_box.addEventListener('click', function(e : any) { e.stopPropagation(); });
            ...
            DateTimeShortcuts.clockHours[name].forEach(function(element) {
                ...
                time_link.addEventListener('click', function(e : any) {
                    e.preventDefault();
            ...
            cancel_link.addEventListener('click', function(e : any) {
                e.preventDefault();
        ...
        addCalendar: function(inp) {
            ...
            today_link.addEventListener('click', function(e : any) {
                e.preventDefault();
            ...
            cal_link.addEventListener('click', function(e : any) {
                e.preventDefault();
            ...
            cal_box.addEventListener('click', function(e : any) { e.stopPropagation(); });

            // next-prev links
            const cal_nav = quickElement('div', cal_box);
            const cal_nav_prev = quickElement('a', cal_nav, '<', 'href', '#');
            cal_nav_prev.className = 'calendarnav-previous';
            cal_nav_prev.addEventListener('click', function(e : any) {
                e.preventDefault();
            ...
            cal_nav_next.addEventListener('click', function(e : any) {
                e.preventDefault();
            ...
            day_link.addEventListener('click', function(e : any) {
                e.preventDefault();
